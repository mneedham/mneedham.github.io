...
In <a href="http://projecteuler.net/problem=11">problem 11</a>, for example, I define the grid of numbers like so:
...
Alternatively we can make use of the <cite><a href="http://www.haskell.org/haskellwiki/Converting_numbers">fromIntegral</a></cite> function to convert from <cite>Integer</cite> to <cite>Int</cite> which in this situation leads to the following code:
